...
'%(nrows)s records found': '%(nrows)s Registro Encontrado',
'%d-%m-%Y': '%d-%m-%Y',
...
'amount_of_activities': 'Quant de Atividades',
...
'average_wage': 'Média Salarial',
'Back': 'Voltar',
'Business Presentation': 'Apresentação de Negocio',
'Buy this book': 'Compre o livro',
"Buy web2py's book": 'Compre o livro do web2py',
'buying_motivator': 'Motivador de Compra',
'cache': 'cache',
'Cache': 'Cache',
...
'Contact and Invite': 'Contactar e Convidar',
'Contact and invites': 'Contact and invites',
...
'No records found': 'Sem Registro Encontrado',
'not in': 'not in',
'not married': 'Solteiro(a)',
'Note': 'Anotação',
'note': 'Anotação',
...
'open_to_business': 'Aberto a Negócio ',
...
'Preface': 'Prefácio',
'Present Product or Business': 'Apresentar Produto ou Negocio ',
'Present product or business': 'Apresentar Produto ou Negocio ',
'previous %s rows': '%s linhas anteriores',
'previous 100 rows': '100 linhas anteriores',
'Process Monitoring': 'Acompanhamento',
'Product Presentation': 'Apresentação de Produto',
'profession': 'Profissão',
'Profile': 'Perfil',
'Promote Event': 'Promover Evento',
...
'Resources': 'Recursos',
'Responsible Sponsorship': 'Patrocínio Responsável ',
'Role': 'Papel',
'Roles': 'Roles',
'Rows in Table': 'Linhas na tabela',
'Rows selected': 'Linhas selecionadas',
'Sale': 'Venda',
'Sale Close': 'Fechamento da Venda',
...
'Work activities': 'Atividades de Trabalho',
